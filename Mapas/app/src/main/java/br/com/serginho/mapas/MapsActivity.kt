...
/*
        val fiapVilaOlimpia = LatLng(-23.5895089, -46.6937765)
        mMap.addMarker(MarkerOptions().position(fiapVilaOlimpia).title(("Fiap Vila Olimpia"))).setIcon(BitmapDescriptorFactory.fromResource(R.drawable.iconfindersatelite1936917_1))
